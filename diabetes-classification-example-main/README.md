...
git clone https://huggingface.co/spaces/nielitropar/Diabetes
...
- 📊 [Live Analytics Dashboard](https://nielitropar-diabetes.hf.space/)
- 📋 [Prediction Logs](https://huggingface.co/datasets/nielitropar/diabetes-logs/blob/main/audit_log.csv)
- 📊 [Raw Data API](https://huggingface.co/datasets/nielitropar/diabetes-logs/raw/main/audit_log.csv)
